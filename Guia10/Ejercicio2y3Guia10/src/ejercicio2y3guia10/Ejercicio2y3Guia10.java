...
public class Ejercicio2y3Guia10 {
    ...
    public static void main(String[] args) {
        ...
        for (Electrodomesticos aux : electro) {
            aux.precioFinal();
            acumulador += aux.getPrecio();
            if (aux instanceof Lavadora) {
                System.out.println("La lavadora color " + aux.getColor()
                        + " Tiene un precio de $" + aux.getPrecio());
            } else {
                System.out.println("El Televisor color " + aux.getColor()
                        + " Tiene un precio de $" + aux.getPrecio());
            }
        }

        System.out.println("El precio de todos los electrodomesticos es de $" + acumulador);
        ...
        Tele.crearTelevisor();
        Tele.precioFinal();
        System.out.println("El precio final de la lavadora es $"+Tele.getPrecio());
         */
    }

 ...
 */
package ejercicioextra3guia10;

import static Comparadores.Comparadores.compararPrecio;
...
public class EjercicioExtra3Guia10 {

    
    public static void main(String[] args) {
        ArrayList hoteles = new ArrayList();
        ArrayList eHoteles = new ArrayList();
        
        for (int i = 0; i < 3; i++) {
            Hotel4Estrellas h = new Hotel4Estrellas();
            Hotel5Estrellas h1 = new Hotel5Estrellas();
            hoteles.add(h);
            hoteles.add(h1);
        }
